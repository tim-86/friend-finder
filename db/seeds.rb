...
puts "creating some friends"
  ...
  %w[🍸 🦥 🚲].each_with_index do |emoji, index|
    ...
    UserInterest.create!(user: tim, interest: interest, index: index)
  end
  ...
  %w[🍣 💃 🐎].each_with_index do |emoji, index|
    interest = Interest.find_by(name: emoji)
    UserInterest.create!(user: marie, interest: interest, index: index)
  end
  ...
  %w[🐶 🚲 🥟].each_with_index do |emoji, index|
    interest = Interest.find_by(name: emoji)
    UserInterest.create!(user: dan, interest: interest, index: index)
  end
  ...
  lucas= User.new(
    ...
    %w[🦥 🤠 👽].each_with_index do |emoji, index|
      interest = Interest.find_by(name: emoji)
      UserInterest.create!(user: lucas, interest: interest, index: index)
    end
